<?php
	...
	mysqli_query($conn,"update tblproduct set description='$name', categoryId= $category, subCategoryId = $subcategory,  price = $price , productImage='$location' where productid=$id");
