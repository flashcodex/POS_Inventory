        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
          ...
          <a class="navbar-brand" >Transaction Processing System</a>
			...
			<ul class=" nav navbar-nav">
                ...
                <li>
                   <a href="order.php"><i class="fa fa-product-hunt fa-fw"></i> Orders </a>
                </li>
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a href="inventory_monitor.php"><span class="fa fa-barcode"></span>  Inventory Stock</a></li>
                    </ul> 
				</li>
				 <li>
                   <a href="cash_receive.php"><i class="fa fa-money fa-fw"></i> Cash Receive </a>
                </li>
			</ul>
