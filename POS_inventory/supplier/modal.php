				...
				<div class="container-fluid">
					<form method="POST" action="update_account.php">
						...
						<div class="form-group input-group">
							...
							<input type="text" style="width:350px;" value="<?php echo $trow['accountUserName']; ?>" class="form-control" name="username">
						</div>
						<div class="form-group input-group">
				...
				<div class="container-fluid">
                    <form role="form" method="POST" action="save_profile.php<?php echo '?id='.$_SESSION['id']; ?>" enctype="multipart/form-data">
						...
						<div class="form-group input-group">
                            ...
                            <input type="text" style="width:330px; text-transform:capitalize;" class="form-control" name="name" value="<?php echo ucwords($srow['supplierName']); ?>">
                        </div>
						<div class="form-group input-group">
                            <span style="width:150px;" class="input-group-addon">Address:</span>
                            <input type="text" style="width:330px; text-transform:capitalize;" class="form-control" name="address" value="<?php echo ucwords($srow['supplierAddress']); ?>">
                        </div>
						<div class="form-group input-group">
                            <span style="width:150px;" class="input-group-addon">Contact Info:</span>
                            <input type="text" style="width:330px;" class="form-control" name="contact" value="<?php echo $srow['telephoneNumber']; ?>">
                        </div>
                        <div class="form-group input-group">
                            <span style="width:150px;" class="input-group-addon">Email:</span>
                            <input type="text" style="width:330px;" class="form-control" name="email" value="<?php echo $srow['emailAddress']; ?>">
                        </div>
						</div>
				</div>                
				</div>
