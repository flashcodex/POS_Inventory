                        ...
                        <div class="form-group input-group">
                          ...
                          <div class="form-group input-group">
                            ...
                            <span class="input-group-addon" style="width:120px;">Province:</span>
                              <select style="width:400px;" class="form-control customerAction" name="province"  id="province" value="<?php echo ucwords($b['province']); ?>">
                                <?php
                         ...
                         <div class="form-group input-group">
                            <span class="input-group-addon" style="width:120px;">City:</span>   
                             <select style="width:400px;" class="form-control customerAction" name="city" id="city">
                                <?php
