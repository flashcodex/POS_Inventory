...
//---------------------- ADD DATA TO DATABASE ---------------------------------------------
	...
	<?php
		...
		$sql = "INSERT INTO tblperson VALUES ('$personId','$firstName','$middleName','$lastName',$sex,$civilStatus,'$bday','$homeNo',$barangay,$city,$province,$zipCode,'$contact','$telnum',4,'$dateToday',$personAddedBy,'$image')";
