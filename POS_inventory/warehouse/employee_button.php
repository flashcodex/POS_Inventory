        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
					<?php
						$a=mysqli_query($conn,"Select tblemployee.*, tblperson.personId, CONCAT(tblperson.firstName,' ',tblperson.firstName,' ',tblperson.firstName,' ') AS 'Fullname' from tblemployee inner join tblperson on tblperson.personId=tblemployee.personId where employeeId ='".$cqrow['employeeId']."'");
                    ...
                    <form role="form" method="POST" action="edit_employee.php<?php echo '?id='.$cqrow['employeeId']; ?>">
						...
						<div class="form-group input-group">
                            <span class="input-group-addon" style="width:120px;">Province:</span>
                              <select style="width:400px;" class="form-control" name="province"  value="<?php echo ucwords($b['province']); ?>">
                                <?php
