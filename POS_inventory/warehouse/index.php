    ...
    <div class="row">
        <div class="col-lg-12">
            <table width="100%" class="table table-striped table-bordered table-hover" id="prodTable">
                <thead>
                    <tr>
                    	<th style="width: 30px">Order Line Id</th>
                ...
                <tbody>
				<?php
					$pq=mysqli_query($conn,"select  tblproduct.* ,tblcustomer.customerId, tblperson.provinceId ,tblorderline.*,CONCAT(tblperson.firstName,' ' ,tblperson.middleName, ' ' ,tblperson.lastName) as 'name',CONCAT(tblbarangay.description,', ' ,tblcity.description, ', ' ,tblprovince.description) as 'address', tblorder.orderId from tblproduct 
                        ...
                        WHERE  tblperson.provinceId = $province AND
						...
						<tr>
							...
							<td>
							 <form role="form" method="POST" action="ship_product.php<?php echo '?id='.$orid; ?>" enctype="multipart/form-data">
								<button class="btn btn-success btn-sm" ><i class="fa fa-check"></i> Ship</button></form>
