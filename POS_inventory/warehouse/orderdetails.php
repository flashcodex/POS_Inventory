    <div class="modal fade" id="details<?php echo $detailsrow['orderLineId'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				...
				<div class="container-fluid">
                    <div class="col-lg-12">
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php
                                        $aa=mysqli_query($conn,"SELECT * , tblproduct.description FROM tblorderline INNER JOIN tblproduct on tblproduct.productId = tblorderline.productId WHERE tblorderline.orderLineId = '".$detailsrow['orderLineId']."'");
