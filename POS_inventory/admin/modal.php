				...
				<div class="container-fluid">
					<form method="POST" action="update_account.php">
						...
						<div class="form-group input-group">
							...
							<input type="text" style="width:350px;" value="<?php echo $srow['accountUserName']; ?>" class="form-control" name="username">
						</div>
						<div class="form-group input-group">
...
<!-- Edit Profile -->
	...
	<?php
		$cq=mysqli_query($conn,"select * from tblaccount inner join `tblperson` on tblperson.personId=tblaccount.personId where tblaccount.personId='".$_SESSION['id']."'");
