                ...
                <div class="container-fluid">
                    ...
                    <form role="form" method="POST" action="edit_product.php<?php echo '?id='.$pid; ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group input-group">
                            ...
                            <select style="width:400px;" class="form-control action" name="Category" id="Category">
                        ...
                        <div class="form-group input-group">
                            ...
                            <select style="width:400px;" class="form-control" name="Subcategory">
                                ...
                                <?php
                                    $c=mysqli_query($conn,"select * from tblSubCategory where subCategoryId != '".$b['subCategoryId']."' and  categoryId='".$b['categoryId']."' ");
                                    while($crow=mysqli_fetch_array($c)){
                                        ?>
                        ...
                        <div class="form-group input-group">
                            ...
                            <select style="width:400px;" class="form-control" name="supplier">
                                <option value="<?php echo $b['supplierId']?>"><?php echo $b['Supplier']; ?></option>
                                <?php
                                    $s=mysqli_query($conn,"select * from tblsupplier where supplierName != '".$b['supplierid']."'");
                                    while($srow=mysqli_fetch_array($s)){
                                        ?>
                                            <option value="<?php echo $srow['supplierId']; ?>"><?php echo $srow['supplierName']; ?></option>
                                        <?php
                                    }
                                ?>
                            </select>
